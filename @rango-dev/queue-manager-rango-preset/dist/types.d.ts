...
export declare enum StepEventType {
    STARTED = "started",
    FAILED = "failed",
    SUCCEEDED = "succeeded",
...
export type Event<T extends StepEventType | RouteEventType, U extends Record<string, unknown> = Record<string, unknown>> = {
    type: T;
    message: string;
...
export type RouteFailedEvent = Event<RouteEventType.FAILED, FailedRouteEventPayload>;
export type RouteSucceededEvent = Event<RouteEventType.SUCCEEDED, SucceededRouteEventPayload>;
export type StepStartedEvent = Event<StepEventType.STARTED>;
export type StepSucceededEvent = Event<StepEventType.SUCCEEDED, SucceededStepEventPayload>;
export type StepFailedEvent = Event<StepEventType.FAILED, FailedStepEventPayload>;
export type StepTxExecutionUpdatedEvent = Event<StepEventType.TX_EXECUTION, StepExecutionEventPayload>;
export type StepTxExecutionBlockedEvent = Event<StepEventType.TX_EXECUTION_BLOCKED, StepBlockedEventPayload>;
export type StepCheckStatusEvent = Event<StepEventType.CHECK_STATUS>;
export type StepApprovalTxSucceededEvent = Event<StepEventType.APPROVAL_TX_SUCCEEDED>;
export type StepOutputRevealedEvent = Event<StepEventType.OUTPUT_REVEALED, OutputRevealedEventPayload>;
export type StepEvent = StepStartedEvent | StepSucceededEvent | StepFailedEvent | StepTxExecutionUpdatedEvent | StepTxExecutionBlockedEvent | StepCheckStatusEvent | StepApprovalTxSucceededEvent | StepOutputRevealedEvent;
export type RouteEvent = RouteStartedEvent | RouteSucceededEvent | RouteFailedEvent;
export type RouteExecutionEvents = {
    [MainEvents.RouteEvent]: {
        route: Route;
        event: RouteEvent;
    };
    [MainEvents.StepEvent]: {
        route: Route;
        step: Step;
        event: StepEvent;
    };
