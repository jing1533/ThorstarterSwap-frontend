import { Networks, WalletTypes, CanSwitchNetwork, Connect, Subscribe, WalletInfo, CanEagerConnect } from '@rango-dev/wallets-shared';
import { mathWallet as mathWallet_instance } from './helpers';
import { SignerFactory, BlockchainMeta } from 'rango-types';
export declare const config: {
    type: WalletTypes;
    defaultNetwork: Networks;
};
export declare const getInstance: typeof mathWallet_instance;
